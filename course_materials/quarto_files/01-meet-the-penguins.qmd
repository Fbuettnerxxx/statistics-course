...
The `penguins` dataset was added to base R 4.5. In case you have an older R version, you either need to update your R version or install the `palmerpenguins` package. The package contains the same data, but uses different variable names.
